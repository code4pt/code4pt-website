    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <p><a class="btn btn-primary btn-large" href="/daas/">Programadores, juntem-se à causa</a></p>
            </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h2>Projetos</h2>
                    <p><ul>
                        <li class="lead"><a href="/daas/"><b>DaaS</b> - uma plataforma para suportar Orçamentos Participativos e debates online.</a></li>
                    </ul></p>
                </div>
            </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                            <p><a class="btn btn-info" href="/daas/contact.php">Quero apoiar-vos &raquo;</a> Há várias maneiras de nos ajudares, começa escolhendo uma.</p>
                        </div>
                        <div class="span4">
                            <p><a class="btn btn-info" href="/daas/contact.php">Quero contactar-vos &raquo;</a> Teremos todo o gosto em ouvir o que tens para dizer.</p>
                        </div>
                    </div>
                </div>
            </div>
